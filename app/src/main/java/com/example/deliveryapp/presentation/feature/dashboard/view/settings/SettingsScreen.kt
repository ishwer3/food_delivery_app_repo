...
data class SettingsItem(
    val title: String,
    val isThemeToggle: Boolean = false
)
...
fun SettingsScreen(
    ...
    val settingsItems = listOf(
        SettingsItem(title = "Dark Mode", isThemeToggle = true),
            ...
            items(settingsItems) { item ->
                if (item.isThemeToggle) {
                    ThemeToggleRow(
                        ...
                        onToggle = { themeViewModel.toggleTheme(it) }
                    )
                } else {
                    SettingsItemRow(
                        item = item,
        ...
        Row(
            ...
            Switch(
                ...
                colors = SwitchDefaults.colors(
                    ...
                    checkedTrackColor = Color(0xFFBF6B3C),
